...
data class ApiResponse<T>(
        @SerializedName("code") val code: String, // String, not Int!
...
data class UserResponse(
        ...
        @SerializedName("is2FAEnabled") val is2FAEnabled: Boolean? = null
) {
    val fullName: String
        get() =
...
data class PostResponse(
        ...
        @SerializedName("reactionCount") val reactionCount: Int = 0,
...
data class ConversationResponse(
        @SerializedName("id") val id: String,
        @SerializedName("type") val type: String? = null, // "private" or "group"
        @SerializedName("participantIds") val participantIds: List<String>,
        @SerializedName("participantNames") val participantNames: Map<String, String>? = null,

        // Enriched by frontend - not from backend API
        val participantAvatars: Map<String, String>? = null,
        @SerializedName("groupId") val groupId: String? = null,
        @SerializedName("lastMessage") val lastMessage: String? = null,
        @SerializedName("lastMessageAt") val lastMessageAt: String? = null,
        @SerializedName("unreadCounts") val unreadCounts: Map<String, Int>? = null,
        @SerializedName("createdAt") val createdAt: String? = null
) {
    val isGroup: Boolean
        get() = type == "group" || groupId != null
    ...
    fun getOtherParticipantAvatar(currentUserId: String): String? {
        if (isGroup) return null
        val otherUserId = participantIds.firstOrNull { it != currentUserId }
        return otherUserId?.let { participantAvatars?.get(it) }
    }
}
...
data class ChatMessageResponse(
        ...
        @SerializedName("type") val type: String? = "TEXT", // TEXT, IMAGE, VIDEO, FILE, DELETE
        @SerializedName("resourceUrls") val resourceUrls: List<String>? = null,
        @SerializedName("createdAt") val createdAt: String? = null,
